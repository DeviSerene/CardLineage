...
std::vector <std::shared_ptr<SoundEffect>> AudioManager::m_soundList;
std::vector <std::shared_ptr<Music>> AudioManager::m_musicList;
...
std::shared_ptr<Music> AudioManager::GetMusic(std::string& _name)
{
	if (!m_musicList.empty())
	{
...
std::shared_ptr<SoundEffect> AudioManager::GetSound(std::string& _name)
{
	if (!m_soundList.empty())
	{
