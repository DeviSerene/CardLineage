...
void GameState::DrawText(SDL_Renderer* _renderer, std::string& _text, SDL_Color _colour, int _x, int _y, int _textsize)
{
	_TTF_Font* font = TTF_OpenFont("assets/manaspc.ttf", _textsize); //font and fontsize
